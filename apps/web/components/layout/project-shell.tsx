...
const groups: readonly NavGroup[] = [
  ...
  { label: "剧情", items: [["整本规划", "planning", BookOpen], ["卷总览", "volumes", BookOpen], ["跨卷连续性", "continuity", History], ["当前卷导演", "director/volume", Sparkles], ["剧情线程", "story-threads", Workflow], ["导演台", "director", Sparkles], ["世界运行", "director?mode=autonomy", PlayCircle]] },
