...
def upgrade():
    op.create_table(
        ...
        sa.Column("start_world_fingerprint", sa.String(120), nullable=False), sa.Column("current_world_fingerprint", sa.String(120), nullable=False), sa.Column("autonomous_run_fingerprint", sa.String(120), nullable=False),
