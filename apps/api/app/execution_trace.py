...
class RecoveryPolicy:
    RULES = {
        ...
        "KNOWLEDGE_LEAK": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "TARGET_MISMATCH": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "INVALID_TARGET": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "INVALID_WORLD_REQUEST": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "PREMATURE_REVEAL": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "INVALID_CANON_REFERENCE": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "INVALID_ENTITY_REFERENCE": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "INVALID_FACT_SUBJECT": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "INVALID_RESOLUTION_STATE": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
        "CROSS_PROJECT_REFERENCE": (False, True, ["AI_REPAIR", "MANUAL_EDIT", "ABORT"]),
